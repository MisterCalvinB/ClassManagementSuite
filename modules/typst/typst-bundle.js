...
${val.stack}`;
  ...
  var import_meta2, wasm2, CLOSURE_DTORS2, cachedDataViewMemory02, cachedUint32ArrayMemory02, cachedUint8ArrayMemory02, heap2, heap_next2, cachedTextDecoder2, MAX_SAFARI_DECODE_BYTES2, numBytesDecoded2, cachedTextEncoder2, WASM_VECTOR_LEN2, IncrServerFinalization, ProxyContextFinalization, TypstCompileWorldFinalization, TypstCompilerFinalization, TypstCompilerBuilderFinalization, TypstFontResolverFinalization, TypstFontResolverBuilderFinalization, IncrServer, ProxyContext, TypstCompileWorld, TypstCompiler, TypstCompilerBuilder, TypstFontResolver, TypstFontResolverBuilder, EXPECTED_RESPONSE_TYPES2, typst_ts_web_compiler_default, importWasmModule2;
  ...
  // modules/typst/typst-entry.js
  var typst_entry_exports = {};
  __export(typst_entry_exports, {
    compilerModule: () => wasm_pack_shim_exports2,
    createTypstCompiler: () => createTypstCompiler,
    createTypstRenderer: () => createTypstRenderer,
    loadFonts: () => loadFonts,
    rendererModule: () => wasm_pack_shim_exports
  });
  ...
  // modules/typst/typst-entry.js
  init_wasm_pack_shim2();
  init_wasm_pack_shim();
  return __toCommonJS(typst_entry_exports);
})();
if(typeof window!=='undefined'){window.TypstLib=TypstLib;}if(typeof globalThis!=='undefined'){globalThis.TypstLib=TypstLib;}
